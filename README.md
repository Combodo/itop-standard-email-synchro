# iTop module : Ticket Creation from Emails (Standard)

## About

This is the a module used in the Mail to ticket automation extension for [iTop](https://github.com/Combodo/iTop).
